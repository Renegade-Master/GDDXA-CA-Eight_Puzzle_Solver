...
class Board implements Comparable<Board> {
	...
	public Iterable<Board> neighbours() {
		...
		// Is 0 the the Top-Left Tile?
		if(this.m_zeroTile == 0) {
			possibleBoards -= 2;
			rightSafe = true;
			downSafe = true;
		}
		// Is 0 the Top-Right Tile?
		else if(this.m_zeroTile == (this.m_order - 1)) {
			possibleBoards -= 2;
			leftSafe = true;
			downSafe = true;
		}
		// Is 0 the Bottom-Left Tile?
		else if(this.m_zeroTile == (this.m_tiles.length - this.m_order)) {
			possibleBoards -= 2;
			rightSafe = true;
			upSafe = true;
		}
		// Is 0 the Bottom-Right Tile?
			...
			/*System.out.println("Blank X:\t" + ((this.m_zeroTile % this.m_order) + 1)
					+ "\nBlank Y:\t" + this.m_zeRow);*/
			...
			if((this.m_zeroTile % this.m_order) == 0) {
				possibleBoards--;
				rightSafe = true;
				upSafe = true;
				downSafe = true;
			...
			else if((this.m_zeroTile % this.m_order) == (this.m_order - 1)) {
				possibleBoards--;
				leftSafe = true;
				upSafe = true;
				downSafe = true;
